...
- name: BOARD_InitPeripherals
  UUID: 0b5ceedf-f47e-4349-87e8-b9417f0052e8
...
ctimer_callback_t CTIMER1_callback[] = {TimerRQ};
...
/* Single callback functions definition */
ctimer_callback_t CTIMER2_callback[] = {timer2IRQ};
...
static void CTIMER2_init(void) {
  ...
  /* Enable interrupt CTIMER2_TIMER_IRQN request in the NVIC */
